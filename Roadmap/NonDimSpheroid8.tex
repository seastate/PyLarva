	...
	\begin{center}
		\resizebox{10.5cm}{!}{
			...
			\begin{tikzpicture}
				\begin{loglogaxis}[
					axis lines = left,
					xlabel = {dissipation rate, \(\epsilon ~\left(\mathrm{\frac{W}{kg}}\right)\)},
					ylabel = {timescale, \(\tau ~(\mathrm{s})\), and length scale, $l ~(\mathrm{m})$},
					]
					%Below the red parabola is defined
					\addplot [
					domain=0.0000000001:0.0001, 
					samples=100, 
					color=red,
					]
					{0.001/sqrt(x)};
					\addlegendentry{\(\tau_K\)}
					%\addlegendentry{Kolmogorov timescale, \(\tau_K\)}
					...
					%\addlegendentry{Stokes timescale, \(\tau\)}
					%Here the blue parabola is defined
					\addplot [
					domain=0.0000000001:0.0001, 
					samples=100, 
					...
					{1e-6/(0.01*0.001/sqrt(x))};
					\addlegendentry{\(l_{min}\)}
					%\addlegendentry{Stokes length scale, \(l\)}
					\addplot [
					domain=0.0000000001:0.0001, 
					samples=10, 
					color=gray,
