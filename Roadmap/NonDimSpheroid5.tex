...
The buoyancy force is the product of a volume and a density difference. 
...
\begin{equation}\label{tau2}
	\tau^*_{rot} = \frac{64 ~ \mu^*}{\Delta \rho^* ~ g ~ \sqrt[\uproot{5}3]{\alpha_s} \Dts}
\end{equation}
Equation \ref{tau2} reflects the fundamental proportional dependence of the buoyancy-driven rotation timescale of an equivalent sphere on size (diameter and aspect ratio), viscosity, medium density, and gravitational acceleration.
